...
from .api.routes import health, directory, pair, choice, stats, image
# Temporarily disabled until adapted to new architecture:
# from .api.routes import gallery, portfolio
